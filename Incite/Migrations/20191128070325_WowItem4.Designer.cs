...
namespace Incite.Migrations
{
    ...
    [Migration("20191128070325_WowItem4")]
    partial class WowItem4
    {
            ...
            modelBuilder.Entity("Incite.Models.WowCharacter", b =>
                {
                    ...
                    b.OwnsMany("Incite.Models.WowCharacterProfession", "WowCharacterProfessions", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("int")
                            ...
                            b1.Property<int>("WowProfessionId")
                                .HasColumnType("int");
                            ...
                            b1.HasIndex("WowProfessionId");

                            b1.ToTable("WowCharacterProfessions");

                            b1.WithOwner("WowCharacter")
                                .HasForeignKey("WowCharacterId");

                            b1.HasOne("Incite.Models.WowProfession", "WowProfession")
                                .WithMany()
